...
\newpage
\section{Text}
This is section "Text". Random Ref. \cite[47]{DUMMY:1} embeddeed in text. Random Ref. \cite[47]{DUMMY:3} embeddeed in text. Random Ref. \cite[47]{DUMMY:4} embeddeed in text.
